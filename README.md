...
Cartpole_LQR.py simulates a classical LQR controller used to produce a baseline for results, shown in experiment 1 results.
Cartple_LQR_NEF.py simulates a LQR controller implemented in nengo and is used for experiments 1, and 2.
...
Cartpole_PD_NEF.py is the decomposed cascaded PD controller using 2 ensembles, implementing the same LQR control law used in experiment 4.
